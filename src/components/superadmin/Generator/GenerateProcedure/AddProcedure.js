...
const AddProcedure = (props) => {
  ...
  const onSubmit = async (e) => {
    ...
    await dispatch(CreateGenerateProcedure(procedureData));
    handleDialogClose();
  };
  ...
  return (
    <>
      ...
      <Dialog
        ...
        maxWidth="md"
      >
        <DialogTitle fontWeight={600}>Add Procedure</DialogTitle>
                ...
                <FormControl fullWidth size="small" sx={{ ml: 2 }}>
                  ...
                  >
                    {categoryList
                      ...
                      ?.acts?.map((desig, index) => (
                        <MenuItem key={desig.act} value={desig._id}>
                          {desig.act}
                        </MenuItem>
                      ))}
                  </Select>
