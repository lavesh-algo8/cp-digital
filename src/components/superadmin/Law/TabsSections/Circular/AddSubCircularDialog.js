...
const AddSubCircularDialog = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(data);
    await dispatch(addSubCircular(data, props.circularId));
    setcircularName("");
    setsubcircularNo("");
  ...
  useEffect(() => {
    if (props) {
      setcircularName(props.circularName);
    }
  }, [props]);
            ...
            <Grid container spacing={2}>
              <Grid item lg={5} md={12}>
                ...
                >
                  ...
                  <Typography sx={{ mt: 2 }}>Sub Circular Number</Typography>
                  <OutlinedInput
                    id="outlined-adornment-weight"
                    value={subcircularNo}
...
export default AddSubCircularDialog;
