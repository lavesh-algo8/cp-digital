...
const AddSubNotificationDialog = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await dispatch(addSubNotification(data, props.notificationId));
    setnotificationName("");
  ...
  useEffect(() => {
    if (props) {
      setnotificationName(props.notificationName);
    }
  }, [props]);
  ...
  return (
    <>
      ...
      <Dialog
        ...
        maxWidth="lg"
      >
        <DialogTitle fontWeight={600}>Add Sub-Notification </DialogTitle>
...
export default AddSubNotificationDialog;
