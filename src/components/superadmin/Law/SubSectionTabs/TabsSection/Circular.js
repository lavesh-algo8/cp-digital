...
import { fetchCircularsBySubSection } from "../../../../../redux/superAdminReducer/superAdminAction";
...
const Circular = () => {
  ...
  const { circularsListBySubSection } = useSelector(
    ...
    <>
      ...
      >
        <DataGrid
          ...
          rows={circularsListBySubSection || []}
